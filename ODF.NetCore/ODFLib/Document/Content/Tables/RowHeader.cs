...
//			this.RowCollection		= new RowCollection();
		...
		private void InitStandards()
		{
			...
			this.RowCollection.Inserted	+=new ODFLib.Document.Collections.CollectionWithEvents.CollectionChange(RowCollection_Inserted);
			this.RowCollection.Removed	+=new ODFLib.Document.Collections.CollectionWithEvents.CollectionChange(RowCollection_Removed);
		}
