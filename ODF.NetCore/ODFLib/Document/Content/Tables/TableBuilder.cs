...
namespace ODFLib.Document.Content.Tables
{
	...
	public class TableBuilder
	{
		...
		/// <returns></returns>
		public static Table CreateSpreadsheetTable(ODFLib.Document.SpreadsheetDocuments.SpreadsheetDocument document, string tableName, string styleName)
		{
		...
		/// <returns></returns>
		public static Table CreateTextDocumentTable(ODFLib.Document.TextDocuments.TextDocument document, string tableName, string styleName, int rows, int columns, double width, bool useTableRowHeader, bool useBorder)
		{
