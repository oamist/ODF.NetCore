...
using ODFLib.Document.Export.OpenDocument;

namespace ODFLib.Document.Export.Html
{
	/// <summary>
	...
	public class OpenDocumentHtmlExporter : IExporter, IPublisherInfo
	{
		...
		private string GetTemplate()
		{
			try
			{
				...
				Stream str			= ass.GetManifestResourceStream("ODFLib.Resources.OD.htmltemplate.html");
