...
namespace ODFLib.Document.SpreadsheetDocuments
{
	...
	/// </summary>
	public class DocumentManifest : ODFLib.Document.TextDocuments.DocumentManifest
	{
		/// <summary>
		...
		public override void New()
		{
			try
			{
				...
				Stream str			= ass.GetManifestResourceStream("ODFLib.Resources.OD.spreadsheetmanifest.xml");
