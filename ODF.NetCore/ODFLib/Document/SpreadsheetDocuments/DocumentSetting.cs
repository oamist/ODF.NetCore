...
namespace ODFLib.Document.SpreadsheetDocuments
{
	...
	/// </summary>
	public class DocumentSetting : ODFLib.Document.TextDocuments.DocumentSetting
	{
		/// <summary>
		...
		public override void New()
		{
			try
			{
				...
				Stream str			= ass.GetManifestResourceStream("ODFLib.Resources.OD.spreadsheetsettings.xml");
