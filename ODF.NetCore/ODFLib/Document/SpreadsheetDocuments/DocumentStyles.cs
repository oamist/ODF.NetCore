...
namespace ODFLib.Document.SpreadsheetDocuments
{
	...
	/// OpenDocument format.
	/// </summary>
	public class DocumentStyles : ODFLib.Document.TextDocuments.DocumentStyles
	{
		/// <summary>
		...
		public override void New()
		{
			try
			{
				...
				Stream str			= ass.GetManifestResourceStream("ODFLib.Resources.OD.spreadsheetstyles.xml");
