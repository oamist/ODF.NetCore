...
namespace ODFLib.Document.Styles
{
	...
	public class TabStopStyleCollection : CollectionWithEvents
	{
		...
		/// <returns></returns>
		public int Add(ODFLib.Document.Styles.TabStopStyle value)
		{
		...
		/// </summary>
		/// <param name="value">The value.</param>
		public void Remove(ODFLib.Document.Styles.TabStopStyle value)
		{
		...
		/// <param name="value">The value.</param>
		public void Insert(int index, ODFLib.Document.Styles.TabStopStyle value)
		{
		...
		/// </returns>
		public bool Contains(ODFLib.Document.Styles.TabStopStyle value)
		{
		...
		/// </summary>
		/// <value></value>
		public ODFLib.Document.Styles.TabStopStyle this[int index]
		{
			get { return (base.List[index] as ODFLib.Document.Styles.TabStopStyle); }
		}
	}
}
