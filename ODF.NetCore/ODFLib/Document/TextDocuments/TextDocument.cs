...
namespace ODFLib.Document.TextDocuments
{
	/// <summary>
...
//		}
		...
		private ODFLib.Document.Content.IContentCollection _content;
		/// <summary>
		/// Collection of contents used by this document.
		/// </summary>
		/// <value></value>
		public ODFLib.Document.Content.IContentCollection Content
		{
			get { return this._content; }
			set { this._content = value; }
		}

		private ODFLib.Document.Styles.IStyleCollection _styles;
		/// <summary>
		/// Collection of local styles used with this document.
		/// </summary>
		/// <value></value>
		public ODFLib.Document.Styles.IStyleCollection Styles
		{
...
//		}
		...
		private void AddFont(string fontname)
		{
			try
			{
				...
				Stream stream		= ass.GetManifestResourceStream("ODFLib.Resources.OD.fonts.xml");
